...
?>
<?php
$metaGeneratorContent = 'Nicepage 4.11.3, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'cheese' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-gradient u-header u-sticky u-sticky-f623 u-header" id="sec-02b4">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/froma.png",
            'default_url' => "https://nicepage.com"
        )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="821" data-image-height="119">
    ...
    <?php
      ...
      <div class="menu-collapse" style="font-size: 1.125rem; letter-spacing: 0px; font-weight: 500; text-transform: uppercase;">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_class' => 'u-active-white u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-hover-grey-10 u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90',
                    'link_style' => 'padding: 10px 14px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-f623-31',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => '',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-f623-33',
                    'submenu_item_class' => 'u-nav-item',
